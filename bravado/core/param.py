...
from bravado.core.http_client import APP_JSON
from bravado.core.marshal import marshal_schema_object
from bravado.core.unmarshal import unmarshal_schema_object
from bravado.core.validate import validate_schema_object
...
class Param(object):
    ...
    def __init__(self, swagger_spec, op, param_spec):
        """
        :type swagger_spec: :class:`bravado.core.spec.Spec`
        :type op: :class:`bravado.core.operation.Operation`
...
def marshal_param(param, value, request):
    ...
    :type param: :class:`bravado.core.param.Param`
...
def unmarshal_param(param, request):
    ...
    :type param: :class:`bravado.core.param.Param`
    :type request: :class:`bravado.core.request.RequestLike`
    """
