...
from bravado.core.response import ResponseLike, unmarshal_response
...
def test_no_content(empty_swagger_spec):
    ...
    with patch('bravado.core.response.get_response_spec') as m:
...
def test_skips_validation(empty_swagger_spec, response_spec):
    ...
    with patch('bravado.core.response.validate_schema_object') as val_schem:
        with patch('bravado.core.response.get_response_spec') as get_resp:
