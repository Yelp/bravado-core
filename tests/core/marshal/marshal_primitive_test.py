...
from bravado.core.marshal import marshal_primitive
...
@mock.patch('bravado.core.marshal.formatter.to_wire')
...
@mock.patch('bravado.core.marshal.formatter.to_wire', return_value=99)
