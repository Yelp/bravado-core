...
from bravado.core.model import create_model_type
from tests.core.model.conftest import pet_spec as pet_spec_fixture
from tests.core.model.conftest import \
...
@mock.patch('bravado.core.model.create_model_docstring', autospec=True)
