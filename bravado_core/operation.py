...
class Operation(object):
    ...
    def __init__(self, swagger_spec, path_name, http_method, op_spec, timeout=None):
    ...
    @classmethod
    def from_spec(cls, swagger_spec, path_name, http_method, op_spec, timeout):
        """
        ...
        """
        op = cls(swagger_spec, path_name, http_method, op_spec, timeout)
